...
return item;},_getCurrentImageTitle:function(){var title="";var currentItem=this._getItem(this.currAlbumId,this.currItemId);console.log(currentItem.data('img-title'))
title=currentItem.data('img-title');return title;},_updateCurrItemId:function(albumId,id){var self=this;self._lastAlbumId=self.currAlbumId;self._lastAlbumNumItems=self.currAlbumNumItems;self._lastItemId=self.currItemId;if(albumId<0){albumId=self.numAlbums-1;}else if(albumId>=self.numAlbums){albumId=0;}
